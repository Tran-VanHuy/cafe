...
$(document).ready(function () {
  var totalPriceVoucher = 0;
  var priceVoucher = 0;
  var voucher_code = '';
  $(".plus-quantity").on('click', function () {
    var tr = $(this).closest('tr');
    var quantityProduct = tr.find('.quantity-product');
    var valueQuantity = Number(quantityProduct.text()) + 1;
  ...
  function priceTotalProduct() {
    var trProductCart = $(".tr-product-cart");

    // Sử dụng map để lấy dữ liệu của tất cả các tr
    var dataProductCart = trProductCart.map(function () {
      return $(this).data('data'); // Lấy data của từng thẻ tr
    }).get(); // Chuyển kết quả thành mảng thực sự

    // Tính tổng giá trị
    var total = dataProductCart.reduce(function (total, item) {
      return total + item.price_product; // Tổng tất cả price_product của các sản phẩm
    }, 0) - priceVoucher;
    $("#price-cart").text((0,_app__WEBPACK_IMPORTED_MODULE_0__.formatted_price)(total));
    $("#total-price-cart").text((0,_app__WEBPACK_IMPORTED_MODULE_0__.formatted_price)(total));
    // Hiển thị tổng giá trị
    var formattedTotal = (0,_app__WEBPACK_IMPORTED_MODULE_0__.formatted_price)(total);
  ...
  $("#apply-voucher").on('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _res$data;
    var value, res, total, _total;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          value = $('#value-voucher').val();
          voucher_code = value;
          _context.next = 4;
          return axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/api/voucher', {
            code: value
          });
        case 4:
          res = _context.sent;
          if (!(res !== null && res !== void 0 && (_res$data = res.data) !== null && _res$data !== void 0 && _res$data.data)) {
            ...
            toastr.success("Yee \u0111\u01A1n h\xE0ng c\u1EE7a b\u1EA1n \u0111\xE3 \u0111\u01B0\u1EE3c gi\u1EA3m  ".concat(res.data.data.formatted_price, "...!"));
            _total = priceTotalProduct().total - res.data.data.price;
  ...
  $('#order-now').click(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var body, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          body = _objectSpread(_objectSpread({}, priceTotalProduct()), {}, {
