...
$(document).ready(function () {
  ...
  $("#submit-product").submit(function (event) {
    ...
    var body = {
      ...
      itemInfo: itemInfo.map(function (item) {
        return {
          name: item.nameItem,
    ...
    if (!itemInfo || itemInfo.length === 0) {
      toastr.error("Ch\u01B0a th\xEAm th\xF4ng tin ".concat(info, "...!"));
    ...
    if (!body.name || !body.price || !body.quantity || !image1 || !image2 || !image3 || !image4 || !image5) {
      ...
      axios.post(PRODUCT_API.CREATE, body).then(function (res) {
