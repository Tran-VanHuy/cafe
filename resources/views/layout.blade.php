            ...
            <footer class="px-[120px] border-t-[2px] pt-[100px] pb-[50px]">
                <div class="flex justify-between">
                    <div>
                        ...
                        <p class="flex items-center gap-[5px] text-gray-500"> Copyright <svg
                        ...
                        <p class="flex items-center gap-[5px] text-gray-500"> Made with <svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <div>
                        ...
                        <div>
                            <input type="text" class="border-none bg-[#efeeec] h-[50px] w-[280px]"
                                placeholder="Nhập địa chỉ e-mail của bạn">
                            <button class="font-bold text-white uppercase h-[50px] bg-black px-[25px]">Đăng ký
                                ngay</button>
                        </div>
                    </div>
