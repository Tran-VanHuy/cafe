...
@section('content')
            ...
            <div class="col-span-1 bg-[#fffffe] cursor-pointer product" data-modal-target="default-modal-01"
                ...
                <div class="py-[12px] flex flex-col justify-between">
                    <div class="mb-[32px]">
                        ...
                        <span class="text-[#a5a5a5] font-[600]">Cappuccino Nóng</span>
                    </div>
            ...
            <div class="col-span-1 bg-[#fffffe] product cursor-pointer" data-modal-target="default-modal-02"
                ...
                <div class="py-[12px] flex flex-col justify-between">
                    <div class="mb-[32px]">
                        ...
                        <span class="text-[#a5a5a5] font-[600]">Kapuchino House Sữa Đá</span>
                    </div>
                    <p class="text-[#b1a995] uppercase font-bold">Add to cart</p>
                </div>
            </div>
            <div class="col-span-1 bg-[#fffffe] product cursor-pointer" data-modal-target="default-modal-03"
                ...
                <div class="py-[12px] flex flex-col justify-between">
                    <div class="mb-[32px]">
                        ...
                        <span class="text-[#a5a5a5] font-[600]">Cà Phê Đen Đá</span>
                    </div>
                    <p class="text-[#b1a995] uppercase font-bold">Add to cart</p>
                </div>
            </div>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="grid grid-cols-12 gap-[32px]  p-[32px]">
                    <div class="col-span-4">
                        <img src="{{ asset('images/Capture_01.PNG') }}" alt="" srcset=""
                            class="w-full rounded-lg h-[300px]">
                    </div>
                    <div class="col-span-8 mt-2">
                        <p class="text-[28px] font-[600] mb-[5px]">Cappuccino Nóng</p>
                        ...
                        <p class="text-[18px] font-[600]">49.000đ<span
                                class="line-through text-[#a4a4a4] text-[14px]">60.700đ</span></p>
                        ...
                        <div class="border-t-[1px]">
                            ...
                            <div class="flex mb-[32px]">
                                <div class="flex items-center mr-1">
                                    ...
                                    <div class="border-[1px] w-[35px] h-[30px] flex items-center justify-center">1</div>
                                    <div class="border-[1px] px-1 h-[30px] flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <div class="flex gap-3 items-center">
                                    ...
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            width="16" height="16" viewBox="0 -2 20 20" version="1.1">
    ...
    <div id="default-modal-02" tabindex="-1" aria-hidden="true"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-[60%] max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="text-center mt-2 flex justify-center cursor-pointer">
                    <svg data-modal-hide="default-modal-02" xmlns="http://www.w3.org/2000/svg" width="22"
                        height="22" fill="#909090" class="bi bi-x" viewBox="0 0 16 16">
                        <path
                            d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708" />
                    </svg>
                ...
                <div class="grid grid-cols-12 gap-[32px]  p-[32px]">
                    <div class="col-span-4">
                        <img src="{{ asset('images/Capture_03.PNG') }}" alt="" srcset=""
                            class="w-full rounded-lg h-[300px]">
                    </div>
                    <div class="col-span-8 mt-2">
                        <p class="text-[28px] font-[600] mb-[5px]">Kapuchino House Sữa Đá</p>
                        <div class="flex items-center gap-1 mb-[5px]">
                            <div class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#d7cdac"
                                    class="bi bi-star" viewBox="0 0 16 16">
                        ...
                        <p class="text-[18px] font-[600]">49.000đ<span
                                class="line-through text-[#a4a4a4] text-[14px]">50.700đ</span></p>
                        <p class="text-[#a4a4a4] text-[14px] mb-[25px]">Có sẵn: In Stock</p>
                        <div class="mb-[35px]">
                            <p class="font-[600] mb-1">SIZE</p>
                            <div class="flex gap-1 text-[14px]">
    ...
    <div id="default-modal-03" tabindex="-1" aria-hidden="true"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-[60%] max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="text-center mt-2 flex justify-center cursor-pointer">
                    <svg data-modal-hide="default-modal-03" xmlns="http://www.w3.org/2000/svg" width="22"
                        height="22" fill="#909090" class="bi bi-x" viewBox="0 0 16 16">
                        <path
                            d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708" />
                    </svg>
                ...
                <div class="grid grid-cols-12 gap-[32px]  p-[32px]">
                    <div class="col-span-4">
                        <img src="{{ asset('images/Capture_04.PNG') }}" alt="" srcset=""
                            class="w-full rounded-lg h-[300px]">
                    </div>
                    <div class="col-span-8 mt-2">
                        <p class="text-[28px] font-[600] mb-[5px]">Cà Phê Đen Đá</p>
                        <div class="flex items-center gap-1 mb-[5px]">
                            <div class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#d7cdac"
                                    class="bi bi-star" viewBox="0 0 16 16">
                        ...
                        <p class="text-[18px] font-[600]">29.000đ<span
                                class="line-through text-[#a4a4a4] text-[14px]">30.700đ</span></p>
                        <p class="text-[#a4a4a4] text-[14px] mb-[25px]">Có sẵn: In Stock</p>
                        <div class="mb-[35px]">
                            <p class="font-[600] mb-1">SIZE</p>
                            <div class="flex gap-1 text-[14px]">
